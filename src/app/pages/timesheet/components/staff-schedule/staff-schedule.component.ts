...
import { SchedulerComponent } from 'src/app/shared/components/scheduler/scheduler.component';
...
export class StaffScheduleComponent implements AfterViewInit {
